...
const techIcons: Record<string, React.ReactNode> = {
  ...
  'PostgreSQL': (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2c-4.971 0-9 2.239-9 5v10c0 2.761 4.029 5 9 5s9-2.239 9-5V7c0-2.761-4.029-5-9-5zm0 2c4.264 0 7 1.791 7 3s-2.736 3-7 3-7-1.791-7-3 2.736-3 7-3zm0 16c-4.264 0-7-1.791-7-3v-2.101C6.637 16.233 9.141 17 12 17s5.363-.767 7-2.101V17c0 1.209-2.736 3-7 3zm0-5c-4.264 0-7-1.791-7-3V9.899C6.637 11.233 9.141 12 12 12s5.363-.767 7-2.101V12c0 1.209-2.736 3-7 3z"/>
    </svg>
  ),
  'Supabase': (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
